...
> 🏛️ **AI Harness Engineering Whitepaper**: For the overarching SOTA AI Harness specification enclosing persona execution (Kernel Sandbox, Declarative Orchestrator, Zero Trust RBAC, MCP Virtualization, and GRC), see **[SOTA AI Harness Architecture](../architecture/sota-whitepaper.md)**.
